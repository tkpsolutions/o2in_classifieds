...
if ($postCategory != null) {
    ...
    $image = "../images/post_category/" . $postCategory->getId() . "." . $postCategory->getImage();
    if (is_file($image)) {
        $imageRequired = "";
    }
    $status = $postCategory->getStatus();
}
?>
...
<head>
    ...
    <title>post Category Management | <?php echo $websiteTitle; ?></title>
                        ...
                        <div class="panel app-panel-1">
                            <div class="panel-heading">
                                <h3 class="panel-title">
                                    ...
                                    if ($postCategoryId > 0) {
                                    ?>
                                        Edit post Category Information
                                        <a href="post-category-view.php" class="btn btn-xs btn-danger pull-right"><i class="fas fa-backward fa-fw"></i> Back </a>
                                    <?php
                                    } else {
                                    ?>
                                        Add post Category Information
                                        <a href="post-category-view.php" class="btn btn-xs btn-danger pull-right"><i class="fas fa-backward fa-fw"></i> Back </a>
                                    <?php
                                    }
                                    ?>
                            ...
                            <div class="panel-body">
                                <form id="form-1">
                                    <input type="text" id="id" name="id" value="<?php echo $postCategoryId; ?>" class="hidden" readonly />
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <?php if (is_file($image)) { ?>
                                                    <div>
                                                        <img src="<?php echo $image; ?>" alt="post Category Image" width="100" height="100" />
                                                    </div>
                                                <?php } ?>
                                            </div>
                                        </div>
                                    </div>
                                    <?php if ($postCategoryId > 0) { ?>
                                        <div class="col-md-6 col-xs-12">
                                            <div class="form-group">
                                                <label>Status</label>
			...
			success: function(data)
			{
				...
				else
				{
					if( data > 0 )
					{
						...
						waitingDialog.hide();
						window.location = "post-category-view.php";
					}
					else
					{
						showAlert("2", "Error: " + data);
